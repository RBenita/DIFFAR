...
- val_wav.json
```
An example can be found [here]([github_IO/index.html](https://github.com/RBenita/DIFFAR/blob/main/Demo_json_files/Demo_wav.json)
...
- val_TextGrid.json
```
An example can be found [here]([github_IO/index.html](https://github.com/RBenita/DIFFAR/blob/main/Demo_json_files/Demo_textgrid.json)
You can generate these files by running:
...
- val_Energy.json
```
An example can be found [here]([github_IO/index.html](https://github.com/RBenita/DIFFAR/blob/main/Demo_json_files/Demo_npy_energy.json)
